<cfcomponent>
	...
	<cffunction name="newUserAddProfImg" access="public">
		<cfargument name="userName" type="any" required="yes">
		<cfargument name="profileimg" type="any" required="yes">
		<cfquery datasource="blog" name="user">
			UPDATE blog.users SET imageName = <cfqueryparam value="#profileimg#"> WHERE userName = <cfqueryparam value="#userName#">
		</cfquery>
	</cffunction>
</cfcomponent>